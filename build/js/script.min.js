...
/*!*********************************!*\
  ...
  \*********************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n/* harmony default export */ __webpack_exports__["default"] = (function () {\n  var twoRangeSlider = function () {\n    var rangeCheck = function rangeCheck(rangeInputs, rangeMinOutput, rangeMaxOutput) {\n      var rangeMin = rangeInputs[0].min ? rangeInputs[0].min : 0;\n      var rangeMax = rangeInputs[0].max ? rangeInputs[0].max : 100;\n      var rangeMinValue = parseInt(rangeInputs[1].value);\n      var rangeMaxValue = parseInt(rangeInputs[0].value);\n      rangeMinValue = Math.min(Math.max(rangeMinValue, rangeMin), rangeMaxValue); // Calculate the percentage of the background where the thumb is\n\n      var rangeMinPercentage = Number((rangeMinValue - rangeMin) * 100 / (rangeMax - rangeMin));\n      var rangeMaxPercentage = Number((rangeMaxValue - rangeMin) * 100 / (rangeMax - rangeMin)); // Update the background to reflect the change\n\n      rangeInputs[0].style.background = "linear-gradient(to right,#3464E0 ".concat(rangeMaxPercentage, "%, #F1F4F9 ").concat(rangeMaxPercentage, "%)");\n      rangeInputs[1].style.background = "linear-gradient(to right,#F1F4F9 ".concat(rangeMinPercentage, "%, transparent ").concat(rangeMinPercentage, "%)"); // Update value on screen\n\n      rangeMinOutput.innerHTML = "".concat(rangeMinValue);\n      rangeMaxOutput.innerHTML = "".concat(rangeMaxValue);\n    };\n\n    var bindComponent = function bindComponent(item) {\n      var rangeInputs = item.querySelectorAll(".js-two-range-slider-input");\n      var rangeMinOutput = item.querySelector(".js-two-range-slider-min-value");\n      var rangeMaxOutput = item.querySelector(".js-two-range-slider-max-value");\n      item.addEventListener("input", function () {\n        // Update value on screen\n        rangeCheck(rangeInputs, rangeMinOutput, rangeMaxOutput);\n\n        for (var i = 0; i < rangeInputs.length; i++) {\n          var directions = {\n            left: rangeMinOutput.value / rangeInputs[i].getAttribute("max") * 100,\n            right: rangeMaxOutput.value / rangeInputs[i].getAttribute("max") * 100\n          };\n          rangeMinOutput.style.left = directions.left + "%";\n          rangeMaxOutput.style.left = directions.right + "%";\n        }\n\n        function toFormat(str) {\n          return str.split("").reverse().join("").match(/\\d{0,3}/g).join(" ").split("").reverse().join("").trim();\n        }\n\n        if (rangeMinOutput.classList.contains("range-money")) {\n          var res = toFormat(rangeMinOutput.value);\n          rangeMinOutput.innerHTML = res;\n        }\n\n        if (rangeMaxOutput.classList.contains("range-money")) {\n          var _res = toFormat(rangeMaxOutput.value);\n\n          rangeMaxOutput.innerHTML = _res;\n        }\n\n        if (rangeMaxOutput.style.left === rangeMinOutput.style.left) {\n          rangeInputs[1].style.display = "none";\n          rangeMinOutput.style.display = "none";\n        } else {\n          rangeInputs[1].style.display = "block";\n          rangeMinOutput.style.display = "block";\n        }\n      });\n      rangeCheck(rangeInputs, rangeMinOutput, rangeMaxOutput);\n    };\n\n    var init = function init() {\n      var rootEl = document.getElementsByClassName("js-two-range-slider");\n\n      _toConsumableArray(rootEl).forEach(function (item) {\n        return bindComponent(item);\n      });\n    };\n\n    return {\n      init: init\n    };\n  }();\n\n  twoRangeSlider.init();\n});\n\n//# sourceURL=webpack:///./src/js/modules/range.js?')},"./src/js/modules/swipe.js":
/*!*********************************!*\
